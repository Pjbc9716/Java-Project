...
import project.windows.MainMenu;
...
public class LogIn extends javax.swing.JFrame {
    ...
    public LogIn(Administrador myList) {
        ...
        music = this.myadiministrador.playMusic();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnReturn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 180, 40));
        ...
        getContentPane().add(btnLogIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 420, 180, 40));
...
//        // TODO add your handling code here:
        ...
        User user = this.myadiministrador.getUserInfo(nickname);
        if (this.myadiministrador.correctInfo(nickname, password)) {
            MainMenu myMainMenu = new MainMenu(this.myadiministrador, user);
            myMainMenu.setVisible(true);
            this.myadiministrador.stopMusic(music);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Informacion incorrecta, por favor verifique su informacion");
        }
