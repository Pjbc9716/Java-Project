...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jblLengthImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Check.png"))); // NOI18N
        getContentPane().add(jblLengthImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 290, -1, -1));

        jblHasSignImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Check.png"))); // NOI18N
    ...
    private void btnRegisterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegisterMouseClicked
        ...
        if (myadministrador.newNickname(nickname) && correctPassword && myadministrador.verifyCountry(country) && passwordMatches) {
            myadministrador.addUser(nickname, password, country, age);
